...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [DEF] = LAYOUT_planck_grid(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_ESC,  LA_TXT,  LA_NUML, LA_NUMR, LA_MSE,  KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY
    ),
    ...
    [TXT] = LAYOUT_planck_grid(
        ...
        _______, _______, _______, _______, _______, _______, _______, LA_MSE2, KC_MPRV, KC_MRWD, KC_MFFD, KC_MNXT
    ),
