...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT_planck_grid(
        ...
        KC_ESC,  OS_GUI,  OS_ALT,  OS_CTRL, OS_SHFT, XXXXXXX, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  KC_PSCR,
    ...
    [MSE] = LAYOUT_planck_grid(
        ...
        KC_ESC,  OS_GUI,  OS_ALT,  OS_CTRL, OS_SHFT, XXXXXXX, KC_BTN4, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN5, XXXXXXX,
